                    ...
                    !userEmail
                        ? <div className="nav-menu-auth">
                            <button className='nav-link__svg' onClick={openModalWindowCart}>
                                {
                                    totalCostCart
                                        ? <svg xmlns="http://www.w3.org/2000/svg" fill="#e5e1ff" viewBox="0 0 24 24"
                                               strokeWidth={1.5}
                                               stroke="currentColor" className="w-6 h-6" width={28} height={28}>
                                ...
                                <div className='nav-link__cart-const'>
                                    {totalCostCart ? totalCostCart : null} {totalCostCart ? '₽' : null}
                                </div>
                            </button>
                            <button className="nav-link__svg" onClick={openModalWindowFavorite}>
                                ...
                                <div className='nav-link__cart-count-favorite'>
                                    {countFavoriteItems ? countFavoriteItems : null}
                                </div>
                            </button>
